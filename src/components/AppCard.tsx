...
const AppCard = ({ name, icon: Icon, color, onClick }: AppCardProps) => {
  return (
    <GlassCard onClick={onClick} className="flex flex-col items-center justify-center gap-2 aspect-square !p-3">
      <div
        className="p-2.5 rounded-xl transition-transform duration-300 group-hover:scale-110 group-hover:rotate-3"
        style={{
          background: `linear-gradient(135deg, ${color}30, ${color}10)`,
          boxShadow: `0 0 16px ${color}25, inset 0 1px 0 ${color}30`,
        }}
      >
